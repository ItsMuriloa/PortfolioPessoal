        ...
        <div className="modal-inner">
          ...
          <div className="contact-options-grid">
            ...
            <div className="contact-option-card">
              ...
              <a href="https://calendly.com/muriloa-pro/30min" target="_blank" rel="noopener noreferrer" className="btn btn-primary contact-btn">
                Marcar reunião
              </a>
            </div>
            ...
            <div className="contact-option-card">
              ...
              <a href="mailto:muriloa.pro@gmail.com" className="btn btn-secondary contact-btn" style={{ width: "100%" }}>
                Enviar e-mail
              </a>
            </div>
          </div>
          ...
          <div className="contact-whatsapp-footer">
            ...
            <a href="https://wa.me/5551994028000" target="_blank" rel="noopener noreferrer" className="btn-whatsapp-link mono">
